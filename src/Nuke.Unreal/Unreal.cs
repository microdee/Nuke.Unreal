...
public static class Unreal
{
    ...
    /// </summary>
    public static EngineVersion Version(IUnrealBuild build) => build.GetEngineVersionFromProject();
    ...
    /// </summary>
    public static bool Is4(IUnrealBuild build) => Version(build).SemanticalVersion.Major == 4;

    /// <summary>
    /// Are we working with UE5
    /// </summary>
    public static bool Is5(IUnrealBuild build) => Version(build).SemanticalVersion.Major == 5;
    ...
    /// Are we working with a vanilla engine most probably installed via the Marketplace?
    /// </summary>
    public static bool IsInstalled(IUnrealBuild build)
    ...
    /// Are we working with an engine built from source?
    /// </summary>
    public static bool IsSource(IUnrealBuild build)
        => IsSource(GetEnginePath(build));

    public static AbsolutePath GetEnginePath(IUnrealBuild build)
