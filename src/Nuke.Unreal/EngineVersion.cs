...
public class EngineVersion
{
    ...
    public static bool operator >= (EngineVersion currentVersion, (int, int) input)
    {
        var (major, minor) = input;
        return currentVersion.SemanticalVersion >= new Version(major, minor);
    }
