...
public partial class ReflectCpp : ModuleRules
{
	bool IsDebug;
	...
	public ReflectCpp(ReadOnlyTargetRules target) : base(target)
	{
		// This is the main module file for using reflect-cpp in Unreal Engine.
		// Because each individual platform can carry different requirements for reflect-cpp,
		// includes and lib imports are expressed in platform specific partial classes. These are
		// auto generated when the library is prepared.
		...
		{
			Logger.LogWarning(
				$"reflect-cpp was not set up for {target.Platform}."
